...
public class AdditionalJavaOptsTest {

    @Deployment
    public static Archive<?> getDeployment() {
        final JavaArchive test = ShrinkWrap.create(JavaArchive.class, "test.jar").addClass(AdditionalJavaOptsTest.class);
    ...
    @Test
    public void test() {
        assertEquals("false", System.getProperty("test.foo"));
    }
}
